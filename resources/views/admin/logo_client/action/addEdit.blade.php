                ...
                <form id="adduserForm">
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3">
                            ...
                            <input @change="handleLogoFiles" class="form-control" type="file" id="formFileMultiple">
                        </div>
                        <!-- Description url -->
                        <div class="col-md-12 mb-3">
                            <label for="website" class="form-label">Website Url</label>
                            <input type="text" v-model="formAdd.website_url" name="website" class="form-control" required></input>
                        </div>
                    </div>
                    <div class="text-end">
