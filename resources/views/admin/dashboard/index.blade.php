				...
				<div class="card-img-overlay d-none d-md-block bottom-0 top-auto">
					<div class="row">
						...
						<div class="col-md-4 col-xl-6 mb-n2">
							<img src="/admin/assets/img/page/dashboard.svg" alt="" class="d-block ms-n3 mb-5" style="max-height: 310px">
						</div>
					</div>
				</div>
				<!-- END card-img-overlay -->
			...
			<div class="row">
				...
				<div class="col-sm-6">
					...
					<div class="card mb-3 overflow-hidden fs-13px border-0 bg-gradient-custom-orange" style="min-height: 199px;">
						...
						<div class="card-img-overlay mb-n4 me-n4 d-flex" style="bottom: 0; top: auto;">
							<img src="/admin/assets/img/icon/order.svg" alt="" class="ms-auto d-block mb-n3" style="max-height: 105px">
						</div>
						<!-- END card-img-overlay -->
					...
					<div class="card mb-3 overflow-hidden fs-13px border-0 bg-gradient-custom-teal" style="min-height: 199px;">
						<!-- BEGIN card-img-overlay -->
						<div class="card-img-overlay mb-n4 me-n4 d-flex" style="bottom: 0; top: auto;">
							<img src="/admin/assets/img/icon/visitor.svg" alt="" class="ms-auto d-block mb-n3" style="max-height: 105px">
						</div>
						<!-- END card-img-overlay -->
				...
				<div class="col-sm-6">
					...
					<div class="card mb-3 overflow-hidden fs-13px border-0 bg-gradient-custom-pink" style="min-height: 199px;">
						<!-- BEGIN card-img-overlay -->
						<div class="card-img-overlay mb-n4 me-n4 d-flex" style="bottom: 0; top: auto;">
							<img src="/admin/assets/img/icon/email.svg" alt="" class="ms-auto d-block mb-n3" style="max-height: 105px">
						</div>
						<!-- END card-img-overlay -->
					...
					<div class="card mb-3 overflow-hidden fs-13px border-0 bg-gradient-custom-indigo" style="min-height: 199px;">
						<!-- BEGIN card-img-overlay -->
						<div class="card-img-overlay mb-n4 me-n4 d-flex" style="bottom: 0; top: auto;">
							<img src="/admin/assets/img/icon/browser.svg" alt="" class="ms-auto d-block mb-n3" style="max-height: 105px">
						</div>
						<!-- end card-img-overlay -->
				...
				<div class="card-body">
					...
					<div class="d-flex align-items-center mb-3">
						<div class="d-flex align-items-center justify-content-center me-3 w-50px h-50px bg-white p-3px rounded">
							<img src="/admin/assets/img/product/product-1.jpg" alt="" class="ms-100 mh-100">
						</div>
						<div class="flex-grow-1">
							<div>
					...
					<div class="d-flex align-items-center mb-3">
						<div class="d-flex align-items-center justify-content-center me-3 w-50px h-50px bg-white p-3px rounded">
							<img src="/admin/assets/img/product/product-2.jpg" alt="" class="ms-100 mh-100">
						</div>
						<div class="flex-grow-1">
							<div>
					...
					<div class="d-flex align-items-center mb-3">
						<div class="d-flex align-items-center justify-content-center me-3 w-50px h-50px bg-white p-3px rounded">
							<img src="/admin/assets/img/product/product-3.jpg" alt="" class="ms-100 mh-100">
						</div>
						<div class="flex-grow-1">
							<div>
					...
					<div class="d-flex align-items-center mb-3">
						<div class="d-flex align-items-center justify-content-center me-3 w-50px h-50px bg-white p-3px rounded">
							<img src="/admin/assets/img/product/product-4.jpg" alt="" class="ms-100 mh-100">
						</div>
						<div class="flex-grow-1">
							<div>
					...
					<div class="d-flex align-items-center">
						<div class="d-flex align-items-center justify-content-center me-3 w-50px h-50px bg-white p-3px rounded">
							<img src="/admin/assets/img/product/product-5.jpg" alt="" class="ms-100 mh-100">
						</div>
						<div class="flex-grow-1">
							<div>
							...
							<tbody>
									...
									<td>
										<div class="d-flex align-items-center">
											<div class="w-40px h-40px">
												<img src="/admin/assets/img/icon/paypal2.svg" alt="" class="ms-100 mh-100">
											</div>
									...
									<td>
										<div class="d-flex align-items-center">
											<div class="w-40px h-40px rounded">
												<img src="/admin/assets/img/icon/mastercard.svg" alt="" class="ms-100 mh-100">
											</div>
											<div class="ms-3 flex-grow-1">
								...
								<tr>
									...
									<td>
										<div class="d-flex align-items-center">
											<div class="w-40px h-40px rounded">
												<img src="/admin/assets/img/icon/visa.svg" alt="" class="ms-100 mh-100">
											</div>
											<div class="ms-3 flex-grow-1">
