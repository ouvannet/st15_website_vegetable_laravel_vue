                ...
                <form id="adduserForm">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" v-model="formAdd.title" name="title" class="form-control" required></input>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="formFileMultiple" class="form-label">Feature Image</label>
                            <input @change="handleFeaturedImage" class="form-control" type="file" id="formFileMultiple">
                        </div>
                        <div class="col-md-12 mb-3">
                            <label for="Content" class="form-label">Content</label>
                            <textarea v-model="formAdd.content" name="Content" class="form-control" rows="5" required></textarea>
                        </div>
                    </div>
                    <div class="text-end">
