    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-10 mb-5 text-center">
                <ul class="product-category">
                    <li><a href="#" @click="() => getProductList(currentPage)" :class="currentCategory==0?'active':''">All</a></li>
                    <li  v-for="(category,index) in dataCategory" :key="index">
                        <a href="#" @click="() => getProductList(currentPage,category.id)" :class="currentCategory==category.id?'active':''">@{{category.name}}</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="row mt-5">
            <div class="col text-center">
                <div class="block-27">
                    <ul>
                        <li v-for="(pagena,index) in dataPagenation" :key="index" :class="pagena.active?'active':''">
                            <a href="#"  @click="() => getProductList(pagena.url ?? 1,currentCategory)">@{{(pagena.label).includes('Previous')?'<':(pagena.label).includes('Next')?'>':pagena.label}}</a>
                        </li>
                    </ul>
                </div>
            </div>
